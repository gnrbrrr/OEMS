<header class="header">
    <div class="logo-container">
        <a href="../" class="logo">
            <img src="{{URL::to('/')}}/theme/assets/images/logo.png" height="35" alt="JSOFT Admin" />
        </a>
                        ...
                        <ul>
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="{{URL::to('/')}}/theme/assets/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle" />
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="{{URL::to('/')}}/theme/assets/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle" />
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="{{URL::to('/')}}/theme/assets/images/!sample-user.jpg" alt="Joe Junior" class="img-circle" />
                                    </figure>
